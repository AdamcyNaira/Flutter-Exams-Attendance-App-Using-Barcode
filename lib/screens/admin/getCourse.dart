...
import 'package:attendance/screens/admin/scan_qr.dart';
...
class GetCourseListItem extends StatefulWidget {
GetCourseListItem ({this.selectedClass});
  final String selectedClass;
  @override
  _GetCourseListItemState createState() => _GetCourseListItemState();
}

class _GetCourseListItemState extends State<GetCourseListItem> {
    ...
    return FutureBuilder(
      ...
      List myData = (snapshot.data);
        if (myData == null) {
          ...
          ? 
          GetCoursesList(selectedClass: widget.selectedClass) 
          : 
          Scaffold( 
            body: Column(
              crossAxisAlignment: CrossAxisAlignment.center,
...
class GetCoursesList extends StatefulWidget {
  GetCoursesList({this.selectedClass});
  final String selectedClass;
  @override
  _GetCoursesListState createState() => _GetCoursesListState();
}

class _GetCoursesListState extends State<GetCoursesList> {
                   ...
                   if (courseData != null) {
                    ...
                    (){
                       Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => MarkedStudentList(selectedClass: widget.selectedClass, selectedCourse: courseData[index]['course_id'],)));
                    }, 
                      () async{
