...
import 'package:attendance/screens/admin/addStaff.dart';
...
class GetStaffList extends StatefulWidget {
  ...
  @override
  _GetStaffListState createState() => _GetStaffListState();
}
...
class StaffList extends StatefulWidget {
  StaffList({this.selectedSemester, this.selectedClass, this.request});
  final selectedSemester;
  final String selectedClass;
  final String request;
  @override
