...
import 'package:attendance/screens/admin/getCourse.dart';
...
class SelectLevelList extends StatefulWidget {

  @override
  _SelectLevelListState createState() => _SelectLevelListState();
}

class _SelectLevelListState extends State<SelectLevelList> {
                ...
                children: [
                  chooseLevel(
                    ...
                    () {
                        ...
                        context,
                        MaterialPageRoute(
                            builder: (context) => GetCourseListItem(selectedClass: "1")));
                    },
                    ...
                    () {
                       Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                            builder: (context) => GetCourseListItem(selectedClass: "2")));
                    },
                    ...
                    () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                            builder: (context) => GetCourseListItem(selectedClass: "3")));
                    },
                    ...
                    () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                            builder: (context) => GetCourseListItem(selectedClass: "4")));
                    },
