...
class GetCourse extends StatefulWidget {
  GetCourse({this.selectedClass});
  final String selectedClass;
  @override
  _GetCourseState createState() => _GetCourseState();
}

class _GetCourseState extends State<GetCourse> {
    ...
    return FutureBuilder(
      ...
      List myData = (snapshot.data);
        if (myData == null) {
          ...
          ? 
          GetCourses(selectedClass: widget.selectedClass) 
          : 
          Scaffold( 
            body: Column(
              crossAxisAlignment: CrossAxisAlignment.center,
                   ...
                   if (courseData != null) {
                    ...
                    (){
                       Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => Scanqr(selectedClass: widget.selectedClass, selectedCourse: courseData[index]['course_id'],)));
                    }, 
                      () async{
